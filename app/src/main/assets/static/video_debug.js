...
class Player {
    ...
    initializeEvents() {
        window.addEventListener('hashchange', ev => {
            ...
            const hash = substringAfter(window.location.hash, '#');
            const seconds = hmsToSecondsOnly(hash);
    ...
    fetchData() {
        ...
        fetch(this.baseAddress + '/api/videos')
    ...
    createItem(object) {
        ...
        coverImage.setAttribute('src', this.baseAddress + object["cover"]);
    ...
    onItemClick(event) {
        ...
        this.video.src = this.baseAddress + href;
